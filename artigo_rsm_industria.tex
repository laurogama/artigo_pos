...
As a result of this research was implemented a temperature and humidity sensor to monitor the work conditions of a computer data server room. These kinds of rooms normally need cold temperatures and low humidity to maintain the proper function of the machines. The prototype was used to assure that both temperature and humidity were in a range satisfactory for workers and machines.
In the future other sensor nodes will be deployed in a office ambient to also monitor the luminance and noise.
