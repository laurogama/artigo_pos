...
The central hub was implemented also using raspberry pi 2 model B running a computer program called \textit{"MQTT server"}, a RabbitMQ broker and  a webserver based on the framework flask\cite{Flask}.
